...
const Footer = () => {
  return (
    <footer
      className="bg-gradient-to-b from-primary-900 to-primary-950 text-white pt-12 pb-6"
      role="contentinfo"
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-8">
          ...
          <div className="space-y-4">
              ...
              <div className="w-10 h-10 flex items-center justify-center">
                <img
                  ...
                  onError={(e) => {
                    ...
                    target.onerror = null;
                    target.src = "/images/logo-cesi.jpg";
                  }}
                />
              </div>
            ...
            <p className="text-primary-100 text-sm">
              Le Club d'Excellence en Systèmes d'Information de l'UCAD, dédié à
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link
                  href="/"
                  className="text-primary-100 hover:text-white transition-colors duration-200 text-sm flex items-center"
                >
                  Accueil
                </Link>
              </li>
            ...
            <address className="not-italic space-y-3">
              ...
              <div className="flex items-center">
                ...
                <a
                  ...
                  className="ml-2 text-primary-100 hover:text-white transition-colors duration-200 text-sm"
                >
                  ucadcesi@gmail.com
                </a>
              </div>
        ...
        <div className="border-t border-primary-800 pt-6">
          ...
          <p className="text-center text-primary-400 text-xs mt-4">
            Conçu et développé par les membres du CESI UCAD
          </p>
        </div>
      </div>
    </footer>
